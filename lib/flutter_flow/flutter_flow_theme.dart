...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFAC00BD);
  late Color secondaryColor = const Color(0xFF39D2C0);
  late Color tertiaryColor = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFF121212);
  late Color secondaryBackground = const Color(0xFF3D3D3D);
  late Color primaryText = const Color(0xFFE2E3E5);
  late Color secondaryText = const Color(0xFF57636C);

  late Color primaryBtnText = Color(0xFF0E1428);
...
class DarkModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFBB86FC);
  late Color secondaryColor = const Color(0xFFAC00BD);
  late Color tertiaryColor = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFF121212);
  late Color secondaryBackground = const Color(0xFF3D3D3D);
  ...
  late Color primaryBtnText = Color(0xFFE2E2E2);
