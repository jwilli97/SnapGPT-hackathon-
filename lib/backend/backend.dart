...
import 'schema/resume_info_record.dart';
...
export 'schema/resume_info_record.dart';
...
/// Functions to query ResumeInfoRecords (as a Stream and as a Future).
Future<int> queryResumeInfoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ResumeInfoRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ResumeInfoRecord>> queryResumeInfoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<ResumeInfoRecord>> queryResumeInfoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ResumeInfoRecord>> queryResumeInfoRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
